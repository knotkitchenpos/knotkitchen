 ...
 *
 * This mirrors `dispatchLabel` in pos-backend/services/menuCache.js and the
 * identical copy in customer-web/src/lib/dispatch.js. They
 * cannot import from each other, so if the wording changes in one it must
 * change in all three: the label a customer read while browsing and the
