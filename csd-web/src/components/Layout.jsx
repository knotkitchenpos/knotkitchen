...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-navy-50">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col bg-navy-950 transition-transform lg:translate-x-0 ${
      ...
      >
        <div className="flex items-center gap-2.5 px-5 py-5">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[11px] font-medium text-navy-400">Business Panel</div>
          </div>
          <button
            type="button"
        ...
        <NavLink
          to="/profile"
          onClick={() => setOpen(false)}
          className="mx-3 mb-4 flex items-center gap-3 rounded-xl border border-navy-800 bg-navy-900 p-3 hover:border-navy-700"
        >
        ...
        <div className="border-t border-navy-800 p-3">
          <div className="px-3 pb-2 text-[11px] uppercase tracking-wider text-navy-500">
